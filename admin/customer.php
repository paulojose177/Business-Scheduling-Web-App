                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <?php
                                ...
                                $showlist = $connection->query("select  customname,cemail from customer;");
...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Customers (<?php echo $showlist->num_rows; ?>)</p>
                    </td>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlstate= "select * from customer order by customerid desc";
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($statresult->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No customers are registered !</p>
