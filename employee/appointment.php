            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $connection->query("select * from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join customer on customer.customerid=appointment.customerid inner join employee on schedule.empid=employee.empid  where  employee.empid=$userid ");
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Appointments (<?php echo $list110->num_rows; ?>)</p>
                    </td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($statresult->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">We  couldnt find any appointments that have been booked !</p>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <option value="" disabled selected hidden>Choose Employee Name from the list</option><br/>';
                                        ...
                                        $showlist = $connection->query("select  * from  employee;");
