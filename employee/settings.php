...
<body>
                    ...
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('../img/icons/delete-buttonblue.svg');"></div>
                                        <div>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $error_1=$_GET["error"];
                $errorlist= array(
                    '1'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">There is already an account for this Email address.</label>',
                    '2'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">There has been an error re-confirming your password! Please re-enter Password to confirm</label>',
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Choose job position: (Current position: '.$job_name.')</label>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="cpassword" class="input-text" placeholder="Please insert Password again" required><br>
                                        </td>
                                    </tr>
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <center>
                        <br><br><br><br>
                            <h2>Edit has been done successfully!</h2>
                            <a class="close" href="settings.php">&times;</a>
                            <div class="content">
                                If you have changed your email then  please do logout and then login back again with your new email
