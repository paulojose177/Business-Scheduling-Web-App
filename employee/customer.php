                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search12" class="input-text header-searchbar" placeholder="Search Customers name or Email" list="customer">&nbsp;&nbsp;
...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)"><?php echo $selecttype." Customers (".$showlist->num_rows.")"; ?></p>
                    </td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($statresult->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">We  couldnt find any customers that are registered  !</p>
    ...
    if($_GET){
        ...
        $id=$_GET["id"];
        $action=$_GET["action"];
            $sqlstate= "select * from customer where customerid='$id'";
            $statresult= $connection->query($sqlstate);
            $row=$statresult->fetch_assoc();
            $name=$row["customname"];
            $email=$row["cemail"];
