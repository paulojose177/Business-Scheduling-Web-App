...
<body>
    ...
    $sqlstate.="order by appointment.appodate  asc";
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">My Appointments (<?php echo $statresult->num_rows; ?>)</p>
                    </td>
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                ...
                                                                <br>
                                                                <a href="?action=drop&id='.$appoid.'&title='.$title.'&doc='.$empname.'" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Cancel Booking</font></button></a>
                                                        </div>
    ...
    if($_GET){
        ...
        if($action=='booking-added'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            ...
                            Employee name&nbsp; : <b>'.substr($empname,0,40).'</b><br><br>
            ...
            $sqlstate= "select * from employee where empid=?";
            $stmt = $connection->prepare($sqlstate);
            ...
            $sqlstate= "select jobtitle from jobposition where id=?";
            $stmt = $connection->prepare($sqlstate);
