            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Scheduled Events</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                $employeerow = $connection->query("select  * from  employee;");
                                $appointmentrow = $connection->query("select  * from  appointment where appodate>='$datetoday';");
                                $schedulerow = $connection->query("select  * from  schedule where scheduledate='$datetoday';");
                ...
                <tr>
                    ...
                    <center>
                    <table class="filter-container employee-header customer-header" style="border: none;width:95%" border="0" >
                    <tr>
                        <td >
                            <h3>Welcome!</h3>
                            <h1><?php echo $username  ?>.</h1>
                            <p>Not sure what to do we'll help out
                                <a href="employees.php" class="non-style-link"><b>"All Employees"</b></a> section or 
                                <a href="schedule.php" class="non-style-link"><b>"Events"</b> </a><br>
                                Track your past and future appointments history.<br>Want to know the expected date for a staff member to meet you? Here.<br><br>
                            </p>
                            
                            <h3>Search for an Employee Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search Employee Name or Email and We will Find The Event Available" list="employees" style="width:45%;">&nbsp;&nbsp;
                                
                                <?php
                                    echo '<datalist id="employees">';
                                    $showlist = $connection->query("select  empname,empemail from  employee;");
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icons/customers-hover.svg');"></div>
                                                    </div>
                                                </td>
                                                </tr>
                                                <tr>
